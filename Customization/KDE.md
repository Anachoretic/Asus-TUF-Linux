...
## Settings:
Open System Settings and go to the Global Themes section. Navigate to the content category you want to customize, then click <kbd>Get New</kbd> in the top-right corner. This will open a new window where you can browse and install available content.
